...
var LivereTower = function() {
  ...
  function template(a, b) {
      ...
      if (a && !(c.indexOf(a) < 0)) return function(a, b) {
          ...
          return c.title = "livere", c.scrolling = "no", c.async = !0, c.frameBorder = 0, c.allowTransparency = "true", c.src = "check" === a ? "https://101.livere.co.kr/html/systemCheck.html" : concatURI(d, b, !0), isRestrictIEVersion(7) && (c.scrolling = "auto", c.height = "1000px"), c
      }(a, b)
  }
  ...
  function getUUID(a) {
      ...
      h.src = "https://was.livere.me/get-uuid", h.title = "livere-uuid", h.id = "livere-uuid", h.style.display = "none", h.onload = c, g.appendChild(h);
  ...
  livere.__version__ = "9.1", livere.init = function() {
      ...
      var c = [10, 13, 30, 36, 39, 48, 49, 66, 427, 649, 936, 938, 982, 1141, 2771, 3662, 5757, 5844, 6204, 6783, 7625, 7817, 7909, 8651, 8808, 9139, 9792, 10020, 10436, 10663, 11659, 12617, 13058, 13149, 13156, 13167, 13314, 13352, 13404, 13448, 13449, 13455, 13457, 13458, 13489, 13511, 13512, 13514, 13529, 13536, 13540, 13552, 13553, 13555, 13582, 13584, 13636, 13637, 13649, 13656, 13665, 13720, 13724, 13770, 13880, 13904, 14002, 14020, 14021, 14026, 14149, 14173, 14254, 14374, 14380, 14584, 15149, 15201, 15414, 15527, 15601, 15759, 16030, 16292, 16302, 16455, 17414, 17554, 17857, 17869, 18803, 18824, 19005, 19483, 19831, 20032, 20048, 20299, 20325, 20424, 20742, 20841, 20903, 21093, 21158, 21551, 21628, 21961, 22094, 22095, 22389, 22473, 22474, 22637, 22711, 22915, 23026, 23069, 23545, 23739, 23792, 23934, 24083, 24229, 24254, 24326, 24704, 24768, 24804, 24974, 25056, 25885, 25934, 26010, 26307, 26392, 26438, 26812, 26956, 27156, 27163, 27166, 27245, 27249, 27312, 27316, 27367, 27401, 27490, 27631, 27733, 28063, 28616, 29070, 29146, 29716, 30266, 30373, 30659, 31292, 31778, 32182, 33092, 33470, 33697, 33798, 34288, 34358, 35470, 35501, 35607, 35657, 35694, 36221, 36227, 36333, 36346, 36417, 36650, 36936, 37489, 39693, 39841, 40205],
      ...
      livere.attachEvents.call(this), set({
      ...
      return a.open = function(a) {
          ...
          return get("lv_utils").style.display = "none", removeEventListener("resize", widget.sidebar.resize)
      ...
      if (b) {
          ...
          if (~location.host.indexOf("tistory.com") && hasProtocol(i.refer) && (i.refer = i.refer.replace(new RegExp("^https?://", "i"), "http://")), !isObjectPropertiesNull(i)) {
              ...
              return i.title = encodeURIComponent(escape(j)), i.titleLength = j.length, i.logo = d ? d.getAttribute("content") : null, i.highlightSeq = h ? h[h.length - 1] : null, i.redirectOrigin = c.redirectOrigin || null, i.preview = !!c.preview && c.preview, c.facebookPageId && c.facebookUploadUrl && (i.facebookPageId = c.facebookPageId, i.facebookUploadUrl = c.facebookUploadUrl), i
          }
      }
  };
  ...
  return addEventListener("scroll", widget.comment.emitPositionEvent, scrollEventTarget), livere.reload = function() {
      ...
      var f = document.querySelector("#lv-container"),
          g = get("lv_comment"),
          h = get("lv_utils");
      if (f && (g && f.removeChild(g), h && document.body.removeChild(h)), variables = {}, bound = {}, (window.livereOptions || {}).eagerLoading) return location.search.indexOf("redirectOrigin=true") > -1 ? widget.oauth.call(this) : livere.start.call(this);
      livere.loading.call(this)
